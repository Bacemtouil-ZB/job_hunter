...
export default function ProfilePage() {
  ...
  const fetchProfile = async () => {
    try {
      // CORRECTED: This will call: http://localhost:8000/api/profile
  ...
  const handleDownloadCV = async () => {
    try {
      // CORRECTED: This will call: http://localhost:8000/api/cv/generate
      const response = await axios.get(`${API_URL}/api/cv/generate`, {
        withCredentials: true,
        responseType: 'blob'
      });
